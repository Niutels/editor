...
// Narrow indexed bands prevent affine UV interpolation from drawing a bright diagonal seam across the tapered ribbon.
export const LANDRUSH_ROBOT_SHOULDER_TORCH_BEAM_RADIAL_SEGMENT_COUNT = 64
export const LANDRUSH_ROBOT_SHOULDER_TORCH_BEAM_SURFACE_TRIANGLE_COUNT =
  LANDRUSH_ROBOT_SHOULDER_TORCH_BEAM_RADIAL_SEGMENT_COUNT * 4
