...
import { PASCAL_WATER_LOW_ELEVATION, type PascalWaterLandSurface } from '@landrush/pascal-plugin'
...
function createNaturalWaterTerrainMaterial(
  ...
  const patch = fieldSample.g
    ...
    .add(0.5)
    .clamp(0, 1)
  const warmSand = color('#c39a47')
  const paleSand = color('#d8b95f')
  const wetSand = color('#ad8240')
