...
export type ParcelBuildNodesSnapshot = ParcelBuildSnapshot<AnyNode>

type ParcelBuildSyncQueueEntry = {
  inFlight: { nodes: AnyNode[]; operationId: string } | null
  parcelId: string
  pendingNodes: AnyNode[] | null
  worldId: string
}
...
export function useLandrushWorldMultiplayer({
  ...
  const flushQueuedParcelBuildSync = useCallback(
    (key: string) => {
      ...
      } satisfies SyncParcelBuildNodesMessage<AnyNode>
...
function cloneParcelBuildNodes(nodes: readonly AnyNode[]) {
