import { landrushPlugin } from '@landrush/pascal-plugin'
import {
...
let externalPluginsPromise: Promise<void> | null = null
...
setPluginDiscovery(async () => [landrushPlugin, treesPlugin])
